...
var vis = d3.select(".skill").append("svg:svg").attr("width", w).attr("height", h).style("float","left");
      var output = d3.select(".skill").append("div");

			var nodes = [];
var languages = {};
languages["Love"] = ["C#", "Ruby", "Jekyll"];
languages["Fun"] = ["HMLT","Javascript","CSS :P"];
